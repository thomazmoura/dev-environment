...
Write-Information "`n->> Move the certificate to $path"
mkdir -p $path
mv -f ./localhost.pfx $path
...
"`$env:ASPNETCORE_Kestrel__Certificates__Default__Path='$path'" >> $HOME/.profile.ps1
